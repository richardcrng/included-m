...
import { DEFAULT_COURSE_ID, LOGO_SRC } from "../constants";
...
function HomePage() {
  return (
    <>
      <IonToolbar>
        <IonTitle>Included M</IonTitle>
      </IonToolbar>
      <IonContent>
        <Container>
          <img src={LOGO_SRC} style={{ filter: "invert" }} />
          <h1>Welcome - and be careful!</h1>
          <p>Welcome to this proof of concept for Included M.</p>
          <p>
            It's under construction - so expect bugs and incomplete content!
          </p>
