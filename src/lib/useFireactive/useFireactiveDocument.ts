...
// import Lesson from "../../models/Lesson.old";
// import Topic from "../../models/Topic";

// export const useFireactiveCourse = makeUseFireactiveDocument(
//   Course,
//   (doc, updateFn) => doc.on("value", updateFn)
// );

// export const useFireactiveTopic = makeUseFireactiveDocument(
//   Topic,
//   (doc, updateFn) => doc.on("value", updateFn)
// );

// export const useFireactiveLesson = makeUseFireactiveDocument(
//   Lesson,
//   (doc, updateFn) => doc.on("value", updateFn)
// );
...
// type UpdateCallback<C extends new (...args: any) => any> = (
//   doc: InstanceType<C>,
//   updateFn: Listener
// ) => void;
...
//     getDocument,
//     documentToState,
//   }: Opts<C, S>): [S | null, InstanceType<C> | null] {
...
//             if (documentToState) {
//               const asState =
//                 documentToState && (await documentToState(foundDocument));
